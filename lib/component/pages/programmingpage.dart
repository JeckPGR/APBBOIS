...
class ProgrammingCoursesPage extends StatefulWidget {
...
class _EnglishCoursesPageState extends State<ProgrammingCoursesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Programming Course', style: TextStyle(color: Colors.white)),
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('Courses')
                    .where('course_Type', isEqualTo: 'Programming')
                    .snapshots(),
